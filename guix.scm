...
;;
;; Guix package definition for I, Human
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace I, Human and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/I, Human")
  (synopsis "Digital trust and CAPTCHA risk audit tool")
