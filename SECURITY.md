...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/i-human/security/advisories/new)
...
- This repository (`hyperpolymath/i-human`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/i-human/security/advisories)
...
When using I, Human, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/i-human/security/advisories)
...
*Thank you for helping keep I, Human and its users safe.* 🛡️
