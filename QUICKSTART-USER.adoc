...
// Replace i-human, I Human — See README.adoc for details., just run, I Human started successfully. with actuals
= i-human — Quick Start for Users
:toc:
:toclevels: 2

== What is i-human?

I Human — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./i-human-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/i-human/wiki
