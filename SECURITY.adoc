...
[arabic]
. Navigate to
https://github.com/hyperpolymath/i-human/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/i-human/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/i-human/discussions[GitHub
Discussions]
...
_Thank you for helping keep I, Human and its users safe._ 🛡️
