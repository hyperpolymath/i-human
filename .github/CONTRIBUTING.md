...
git clone <https://github.com/hyperpolymath/i-human.git> cd i-human
...
toolbox create i-human-dev toolbox enter i-human-dev \# Install
...
i-human/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/i-human/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/i-human/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/i-human/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/i-human/labels/perimeter-3) — Community sandbox scope
